...
namespace Shop_store.Controllers
{
    [ApiController]
    [Route("[controller]")]
    //[Authorize]   Authenticating a user through Google Console via SWAGGER UI is not working, but calling it directly using //account/login is successful.
    ...
    public class ShoppingCartControllerTest : ControllerBase
    {
        ...
        private readonly ILogger<AccountControllerTest> _logger;
        ...
        public ShoppingCartControllerTest(IShoppingCartService shoppingCartService, IUserService userService, ILogger<AccountControllerTest> logger)
        {
